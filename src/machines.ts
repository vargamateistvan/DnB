...
export const DEFAULT_MACHINE_PARAMS: MachineParams = {
  tr808: { shuffle: 0, accentLevel: 0.3, kickTune: 0.5, tomLoTune: 0.5, tomHiTune: 0.5 },
  ...
  tb303: { cutoff: 0.3, resonance: 0.65, envMod: 0.65, decay: 0.45, accent: 0.55, waveform: 'sawtooth', detune: 0.5, transpose: 0 },
  sh101: { vcfFreq: 0.45, vcfRes: 0.35, vcfEnv: 0.5, vcfMod: 0.25, subOsc: 0.35, waveform: 'pulse', portamento: 0.08, pitchBend: 0, detune: 0.5, transpose: 0 },
}
